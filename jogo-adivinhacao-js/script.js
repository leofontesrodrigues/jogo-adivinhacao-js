/*O sistema sorteia um numero aleatório
o sistema pede um palpite para o usuário
se acertar, venceu se não o sistema
avisa se foi maior ou menor
...
function rodarJogo() {
    while(tentativas > 0) {
        let palpite = Number(prompt('Advinhe o número sorteado entre 0 e 50.'));
